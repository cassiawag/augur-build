...
if __name__ == '__main__':
    ...
    parser.add_argument('-r', '--resolutions', nargs='+', type = str,  help ="flu resolutions to include", default=['1y', '18-19y'])
    ...
    for lineage in params.lineages:
        for resolution in params.resolutions:
            for segment in params.segments:
                targets.append('auspice/flu_seasonal_%s_%s_%s.json'%(lineage, segment, resolution))
