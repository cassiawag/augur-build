...
def mapping(coor, label, city = None):
...
def color_assignment(lat_long_sorted, output_fname, label):
    ...
    final_colors_df = lat_long_sorted[[label, 'color']]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--city', type=str, help="if 'Seattle' is specified, it limits lat/long to city limits -- not required to run script")
...
coor_mapping, original_df = mapping(args.coordinates, args.label, city = args.city)
